...
class CommandLongResponse(genpy.Message):
  _md5sum = "05a1be4ea1d4023975a944262b6a822f"
...
"""
  __slots__ = ['success','result','result_param1','result_param2']
  _slot_types = ['bool','uint8','uint8','int32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       success,result,result_param1,result_param2
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_3Bi().pack(_x.success, _x.result, _x.result_param1, _x.result_param2))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.success, _x.result, _x.result_param1, _x.result_param2,) = _get_struct_3Bi().unpack(str[start:end])
...
class CommandLong(object):
  ...
  _md5sum = 'ea093105f3c91807f0bb5562240a698a'
