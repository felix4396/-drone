...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<CommandLong-request>)))
  ...
  "ea093105f3c91807f0bb5562240a698a")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'CommandLong-request)))
  "Returns md5sum for a message object of type 'CommandLong-request"
  "ea093105f3c91807f0bb5562240a698a")
...
(cl:defmethod result_param1-val ((m <CommandLong-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavros_msgs-srv:result_param1-val is deprecated.  Use mavros_msgs-srv:result_param1 instead.")
  (result_param1 m))

(cl:ensure-generic-function 'result_param2-val :lambda-list '(m))
(cl:defmethod result_param2-val ((m <CommandLong-response>))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<CommandLong-response>)))
  ...
  (cl:format cl:nil "bool success~%# raw result returned by COMMAND_ACK~%uint8 result~%uint8 result_param1~%int32 result_param2~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'CommandLong-response)))
  "Returns full string definition for message of type 'CommandLong-response"
  (cl:format cl:nil "bool success~%# raw result returned by COMMAND_ACK~%uint8 result~%uint8 result_param1~%int32 result_param2~%~%~%~%"))
